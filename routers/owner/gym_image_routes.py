...
gym_image_router = APIRouter(tags=["Owner"])

@gym_image_router.post("/owners/{owner_id}/upload-images", response_model=GymImageResponse)
...
@gym_image_router.get("/owners/{owner_id}/upload-images", response_model=list[GymImageResponse])
